...
class NeuralNetwork():
    ...
    def train(self, training_inputs, training_outputs, training_iterations):
        for iteration in range(training_iterations):
            ...
            adjustments = numpy.dot(training_inputs.T, error * self.sigmoid_derivative(output))
